...
# Updated to use redis6-cli for Amazon Linux compatibility
...
case "$MODE" in
  ...
  existing-dataset)
    ...
    redis6-cli SET "stats:111111111111111111" "42.75"
    redis6-cli SET "stats:222222222222222222" "18.50"
    redis6-cli SET "stats:333333333333333333" "67.20"
